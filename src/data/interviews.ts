...
const INTERVIEW_QUESTIONS: Record<string, InterviewQuestion[]> = {
  ...
  corporate: [
    ...
    },
    {
      ...
      options: ['A fast algorithm', 'When multiple processes access shared data unpredictably', 'A testing methodology', 'A type of loop'],
      correctIndex: 1,
      explanation: 'Race conditions occur when multiple threads/processes access shared resources in an unpredictable order.',
    },
    {
    ...
    },
    {
      ...
      options: ['Rapid Endpoint Service Technology', 'Representational State Transfer', 'Remote Execution Standard Type', 'Resource Entity State Transfer'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['A secure encryption method', 'When two processes wait forever for each other', 'A terminated process', 'A locked file'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Programming at runtime', 'Solving problems by breaking them into overlapping subproblems', 'Using dynamic typing', 'Rapid prototyping'],
      correctIndex: 1,
      explanation: 'Dynamic programming solves complex problems by breaking them into simpler overlapping subproblems and storing solutions.',
    },
    {
      question: 'What is the difference between BFS and DFS?',
      options: ['BFS uses stack, DFS uses queue', 'BFS explores level by level, DFS explores depth first', 'They are identical', 'DFS is always faster'],
      correctIndex: 1,
      explanation: 'BFS (Breadth-First) explores neighbors first using a queue. DFS (Depth-First) explores as deep as possible using a stack.',
    },
    {
      question: 'What is "Big O" notation used for?',
      options: ['Measuring code quality', 'Describing algorithm efficiency', 'Defining API contracts', 'Testing complexity'],
      correctIndex: 1,
      explanation: 'Big O describes the worst-case time or space complexity of algorithms.',
    },
    {
      question: 'What is a "hash collision"?',
      options: ['When two keys produce the same hash value', 'A database error', 'A network failure', 'A memory overflow'],
      correctIndex: 0,
      explanation: 'Hash collision occurs when two different inputs produce the same hash output, requiring resolution strategies like chaining.',
    },
  ],
  ...
  management: [
    // Easy (Level 1-2)
    {
      ...
      options: ['Assign tasks for next sprint', 'Demo completed work', 'Reflect and improve team processes', 'Review code quality'],
      correctIndex: 2,
    ...
    },
    {
      ...
      options: ['Work In Progress limit', 'Weekly Improvement Plan', 'Worker Integration Policy', 'Workflow Inspection Point'],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: ['Micromanage every task', 'Remove blockers for the team', 'Make all technical decisions', 'Avoid team conflicts'],
      correctIndex: 1,
      explanation: 'Servant leaders empower teams by removing obstacles and supporting their success.',
    },
    {
      question: 'What is "technical debt"?',
      options: ['Money owed to contractors', 'Future cost of shortcuts taken today', 'Team training budget', 'Infrastructure expenses'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['A meeting while standing for exercise', 'A brief daily sync on progress and blockers', 'A formal presentation', 'An end-of-project review'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Write code', 'Facilitate Scrum ceremonies and remove impediments', 'Approve all designs', 'Hire new team members'],
      correctIndex: 1,
      explanation: 'Scrum Masters facilitate the Scrum process, protect the team, and help remove impediments.',
    },
    {
      question: 'What is a "user story"?',
      options: ['A customer testimonial', 'A requirement written from the user perspective', 'A bug report', 'A code comment'],
      correctIndex: 1,
      explanation: 'User stories describe requirements from the end-user perspective: "As a [user], I want [feature] so that [benefit]."',
    },
    // Medium (Level 3)
    {
    ...
    },
    {
      ...
      options: ['Ignore it', 'Fire one of them', 'Facilitate a private conversation to find common ground', 'Take sides publicly'],
      correctIndex: 2,
    ...
    },
    {
      ...
      options: ['Physical workspace safety', 'Feeling safe to take risks and speak up without fear', 'Job security', 'Mental health coverage'],
      correctIndex: 1,
      explanation: 'Psychological safety means team members feel safe to take risks, share ideas, and admit mistakes without punishment.',
    },
    {
      question: 'What is the difference between a Product Owner and a Scrum Master?',
      options: ['They are the same role', 'PO manages backlog priorities, SM facilitates process', 'SM writes code, PO tests', 'PO manages people, SM manages budget'],
      correctIndex: 1,
      explanation: 'Product Owners manage the product backlog and priorities. Scrum Masters facilitate the Scrum process.',
    },
    {
      question: 'What is "scope creep"?',
      options: ['A bug type', 'Uncontrolled expansion of project requirements', 'Code refactoring', 'Team growth'],
      correctIndex: 1,
      explanation: 'Scope creep is the uncontrolled expansion of project scope without adjusting time, cost, or resources.',
    },
    {
      question: 'What is a "burndown chart"?',
      options: ['A stress indicator', 'A graph showing remaining work over time', 'A team mood tracker', 'A performance review'],
      correctIndex: 1,
    ...
    // Hard (Level 4)
    {
      ...
      options: ['They are identical', 'Management focuses on processes, leadership on inspiring people', 'Leadership pays more', 'Management is outdated'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Immediately fire them', 'Provide feedback, set clear expectations, and offer support', 'Ignore the problem', 'Publicly criticize them'],
      correctIndex: 1,
      explanation: 'Address underperformance with constructive feedback, clear expectations, coaching, and support before escalation.',
    },
    {
      question: 'What is "situational leadership"?',
      options: ['Leading only in emergencies', 'Adapting leadership style based on team maturity and task', 'Leadership by committee', 'Remote leadership'],
      correctIndex: 1,
      explanation: 'Situational leadership adapts leadership style (directing, coaching, supporting, delegating) based on team needs.',
    },
    {
      question: 'What is the "RACI matrix"?',
      options: ['A performance rating', 'Responsible, Accountable, Consulted, Informed - a responsibility assignment chart', 'A testing framework', 'A budget allocation tool'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Managing team salaries', 'Building relationships and managing expectations of interested parties', 'Stock management', 'Resource allocation'],
      correctIndex: 1,
      explanation: 'Stakeholder management involves identifying, analyzing, and engaging people affected by or affecting the project.',
    },
    {
      question: 'What is "OKR" methodology?',
      options: ['Objectives and Key Results - a goal-setting framework', 'Operational Knowledge Review', 'Organizational Key Roles', 'Output Quality Rating'],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: ['Version control', 'Systematic approach to transitioning individuals and organizations through change', 'Changing managers frequently', 'Budget revisions'],
      correctIndex: 1,
      explanation: 'Change management is a structured approach to help people adopt new processes, technologies, or organizational changes.',
    },
  ],
  ...
  ic: [
    // Easy (Level 1-2)
    {
      ...
      options: ['Consistency, Availability, Partition tolerance', 'Code, Architecture, Performance', 'Caching, API, Persistence', 'Concurrency, Asynchrony, Parallelism'],
      correctIndex: 0,
      explanation: 'CAP theorem: distributed systems can only guarantee 2 of 3 - Consistency, Availability, Partition tolerance.',
    },
    {
    ...
    },
    {
      ...
      options: ['Adding more RAM to a server', 'Adding more servers to handle load', 'Improving code efficiency', 'Reducing database size'],
      correctIndex: 1,
      explanation: 'Horizontal scaling (scaling out) adds more machines to handle increased load.',
    },
    {
      question: 'What is a "CDN"?',
      options: ['Content Delivery Network - distributed servers for faster content delivery', 'Central Database Node', 'Code Deployment Network', 'Customer Data Network'],
      correctIndex: 0,
      explanation: 'CDNs distribute content across geographically dispersed servers to reduce latency.',
    },
    {
      question: 'What is "latency"?',
      options: ['Server memory usage', 'Time delay between request and response', 'Network bandwidth', 'CPU utilization'],
      correctIndex: 1,
    ...
    // Medium (Level 3)
    {
      ...
      options: ['Encrypting database', 'Splitting data across multiple databases', 'Backing up data', 'Indexing tables'],
      correctIndex: 1,
      explanation: 'Sharding partitions data across multiple databases to improve scalability and performance.',
    },
    {
      question: 'What is the difference between SQL and NoSQL databases?',
      options: ['SQL is faster', 'SQL uses structured schemas, NoSQL is more flexible', 'NoSQL is deprecated', 'They are identical'],
      correctIndex: 1,
      explanation: 'SQL databases use structured schemas and relationships. NoSQL offers flexible schemas and horizontal scaling.',
    },
    {
      question: 'What is a "message queue"?',
      options: ['An email system', 'Asynchronous communication between services', 'A logging system', 'A database type'],
      correctIndex: 1,
      explanation: 'Message queues enable asynchronous communication, decoupling producers and consumers of messages.',
    },
    {
      question: 'What is "eventual consistency"?',
      options: ['Immediate data sync', 'Data becomes consistent over time, not immediately', 'Database never syncs', 'Manual data sync'],
      correctIndex: 1,
      explanation: 'Eventual consistency means all replicas will converge to the same state, but not immediately after writes.',
    },
    {
      question: 'What is a "reverse proxy"?',
      options: ['A backup server', 'Server that forwards client requests to backend servers', 'A firewall', 'A database replica'],
      correctIndex: 1,
      explanation: 'Reverse proxies sit in front of backend servers, forwarding client requests and providing caching, load balancing, and security.',
    },
    {
      question: 'What is "rate limiting"?',
      options: ['Speeding up requests', 'Controlling the number of requests a client can make', 'Measuring response times', 'Prioritizing requests'],
      correctIndex: 1,
    ...
    // Hard (Level 4)
    {
      ...
      options: ['A code review process', 'A distributed transaction protocol ensuring all-or-nothing commits', 'A deployment strategy', 'A testing methodology'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Team agreement', 'Agreement among distributed nodes on data values', 'Code review approval', 'Management decision'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Electrical safety', 'Preventing cascading failures by stopping requests to failing services', 'A testing pattern', 'A database pattern'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Command Query Responsibility Segregation - separating read and write models', 'Central Query Response System', 'Cached Query Result Storage', 'Concurrent Queue Response Service'],
      correctIndex: 0,
      explanation: 'CQRS separates read and write operations into different models for optimization and scalability.',
    },
    {
      question: 'What is "event sourcing"?',
      options: ['Logging events', 'Storing all changes as a sequence of events instead of current state', 'Event-driven architecture', 'Source control for events'],
      correctIndex: 1,
      explanation: 'Event sourcing stores every change as an immutable event, allowing complete history reconstruction.',
    },
    {
      question: 'What is the difference between "vertical" and "horizontal" partitioning?',
      options: ['They are identical', 'Vertical splits columns, horizontal splits rows', 'Vertical is faster', 'Horizontal uses more memory'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Encryption across servers', 'Mechanism to ensure only one process accesses a resource across nodes', 'Network firewall', 'Database constraint'],
      correctIndex: 1,
  ...
  hustler: [
    ...
    },
    {
      ...
      options: ['Wait for them to find you', 'Cold outreach and platforms like Upwork/Fiverr', 'Only rely on referrals', 'Paid advertising only'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Legal requirement', 'Shows potential clients your skills and past work', 'Tax purposes', 'Required for freelance platforms'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['A telescope accessory', 'The defined work and deliverables for a project', 'Code optimization', 'Testing methodology'],
      correctIndex: 1,
    ...
    // Medium (Level 3)
    {
      ...
      options: ['Writing minimal code', 'Building apps with visual tools instead of traditional coding', 'Deleting code', 'Code obfuscation'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Impressing clients', 'Accurate billing and productivity analysis', 'Legal compliance', 'Social media content'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['One-time payments', 'Predictable income from ongoing services/subscriptions', 'Refunds', 'Charity donations'],
      correctIndex: 1,
      explanation: 'Recurring revenue provides stable, predictable income - essential for freelancer financial stability.',
    },
    {
      question: 'What is a "retainer" agreement?',
      options: ['A lawyer contract', 'Client pays monthly for guaranteed availability/hours', 'Equipment rental', 'Office lease'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['80% work, 20% vacation', '80% of revenue often comes from 20% of clients', '80% planning, 20% execution', '80 hours per week minimum'],
      correctIndex: 1,
    ...
    // Hard (Level 4)
    {
      ...
      options: ['Selling physical products', 'Standardized service packages with fixed scope and price', 'Manufacturing software', 'Product photography'],
      correctIndex: 1,
      explanation: 'Productized services are standardized offerings with clear deliverables and fixed pricing, easier to sell and scale.',
    },
    {
      question: 'What is "value-based pricing"?',
      options: ['Charging minimum wage', 'Pricing based on value delivered to client, not hours worked', 'Discount pricing', 'Market average pricing'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Tax avoidance', 'Income that doesn\'t require active time-for-money trade', 'Client requirement', 'Industry regulation'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Using white backgrounds', 'Providing services that clients resell under their brand', 'Label printing', 'Clean code practices'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Exploring new technologies', 'Initial call to understand client needs and qualify the project', 'Bug discovery session', 'Team meeting'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Being a generalist', 'Focusing on specific industry/service for expertise and higher rates', 'Narrow-minded thinking', 'Working less'],
      correctIndex: 1,
  ...
  business: [
    // Easy (Level 1-2)
    {
      ...
      options: ['Your product solves a real problem for customers', 'Your product looks good', 'Your team is happy', 'You have funding'],
      correctIndex: 0,
      explanation: 'Product-Market Fit means your product satisfies real market demand.',
    },
    {
      question: 'What does "CAC" mean in SaaS?',
      options: ['Customer Acquisition Cost', 'Code Analysis Check', 'Centralized Access Control', 'Cloud Application Cache'],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: ['Maximum Revenue Rate', 'Monthly Recurring Revenue', 'Marketing Response Ratio', 'Minimum Required Resources'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Rotating office chairs', 'Changing business direction based on learning', 'Firing employees', 'Moving to a new office'],
      correctIndex: 1,
    ...
    // Medium (Level 3)
    {
      ...
      options: ['Long-Term Vision', 'Total revenue expected from a customer over their lifetime', 'Legal Term Validation', 'Lead Time Variance'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Everything is free', 'Basic features free, premium features paid', 'Free trials only', 'Discounted pricing'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Network Protocol Standard', 'Measures customer loyalty via likelihood to recommend', 'New Product Sales', 'Non-Profit Status'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Marketing-driven growth', 'The product itself drives acquisition and retention', 'CEO-led growth', 'Sales-led growth'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Team performance review', 'Analyzing groups of users who signed up at the same time', 'Competitor analysis', 'Code review'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Office supply costs', 'Profitability analysis per customer/transaction', 'Real estate costs', 'Salary calculations'],
      correctIndex: 1,
    ...
    // Hard (Level 4)
    {
      ...
      options: ['40 employees minimum', 'Growth rate + profit margin should equal or exceed 40%', '40 hour work week', '40% market share'],
      correctIndex: 1,
      explanation: 'Rule of 40: healthy SaaS companies should have revenue growth % + profit margin % ≥ 40%.',
    },
    {
      question: 'What is "negative churn"?',
      options: ['Losing customers', 'Revenue from existing customers grows faster than revenue lost from churn', 'Churning butter backwards', 'Customer acquisition'],
      correctIndex: 1,
      explanation: 'Negative churn means expansion revenue from existing customers exceeds lost revenue from churned customers.',
    },
    {
      question: 'What is "quick ratio" in SaaS?',
      options: ['Speed of payment', '(New MRR + Expansion MRR) / (Churned MRR + Contraction MRR)', 'Current assets ratio', 'Response time metric'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Fire safety metric', 'Net burn / Net new ARR - measures efficiency of growth spending', 'CPU usage', 'Employee burnout rate'],
      correctIndex: 1,
      explanation: 'Burn multiple shows how much you\'re spending to generate each dollar of new ARR.',
    },
    {
      question: 'What is "PLG flywheel"?',
      options: ['A gym equipment', 'Self-reinforcing cycle where product usage drives growth', 'Email marketing', 'Sales pipeline'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Office expansion costs', 'Additional revenue from existing customers (upsells, upgrades)', 'New customer revenue', 'Investment funding'],
      correctIndex: 1,
  ...
  specialist: [
    // Easy (Level 1-2)
    {
      ...
      options: ['Systems mirror org structure', 'Code must have comments', 'Tests run before deployment', 'APIs need versioning'],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: ['Store API documentation', 'Single entry point for API requests', 'Generate API keys', 'Test API endpoints'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Data will be consistent immediately', 'Data will be consistent given enough time', 'Data is never consistent', 'Data requires manual sync'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Building design', 'High-level structure of software systems and their interactions', 'Hardware specifications', 'Office layout'],
      correctIndex: 1,
      explanation: 'Technical architecture defines how system components are organized and interact.',
    },
    {
      question: 'What is a "service mesh"?',
      options: ['Fishing equipment', 'Infrastructure layer handling service-to-service communication', 'Network cables', 'Database cluster'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Website design', 'Designing software around business domains and language', 'Database design', 'UI/UX design'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['A plant disease', 'Gradually replacing legacy systems by building new around old', 'A security vulnerability', 'A testing method'],
      correctIndex: 1,
      explanation: 'Strangler fig pattern incrementally replaces legacy systems by routing traffic to new implementations.',
    },
    {
      question: 'What is "infrastructure as code"?',
      options: ['Writing code on servers', 'Managing infrastructure through machine-readable definition files', 'Hardware documentation', 'Code comments'],
      correctIndex: 1,
      explanation: 'IaC manages infrastructure using code (Terraform, CloudFormation) for consistency and version control.',
    },
    {
      question: 'What is a "saga pattern" in microservices?',
      options: ['A long story', 'Managing distributed transactions through a sequence of local transactions', 'A logging pattern', 'A deployment strategy'],
      correctIndex: 1,
      explanation: 'Sagas manage distributed transactions by breaking them into local transactions with compensating actions.',
    },
    {
      question: 'What is "sidecar pattern"?',
      options: ['Motorcycle accessory', 'Deploying helper containers alongside main containers', 'A security pattern', 'A caching strategy'],
      correctIndex: 1,
      explanation: 'Sidecar pattern deploys supporting functionality in a separate container alongside the main application.',
    },
    {
      question: 'What is "observability" in systems?',
      options: ['Code visibility', 'Ability to understand system state from external outputs (logs, metrics, traces)', 'UI monitoring', 'Code reviews'],
      correctIndex: 1,
      explanation: 'Observability combines logging, metrics, and tracing to understand system behavior and debug issues.',
    },
    // Hard (Level 4)
    {
      question: 'What is "cell-based architecture"?',
      options: ['Biological computing', 'Dividing system into isolated cells for fault tolerance', 'Spreadsheet design', 'Mobile architecture'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Email sending', 'Ensuring reliable event publishing with transactional outbox table', 'File storage', 'Message queuing'],
      correctIndex: 1,
      explanation: 'Outbox pattern uses a database table to reliably publish events alongside local transactions.',
    },
    {
      question: 'What is "chaos engineering"?',
      options: ['Random coding', 'Deliberately injecting failures to test system resilience', 'Unstructured development', 'Breaking things randomly'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Multiple buildings', 'Single instance serving multiple customers with data isolation', 'Team collaboration', 'Microservices'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Hollywood pattern', 'Concurrency model where actors communicate via messages', 'User role management', 'Testing with actors'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Database networking', 'Decentralized data architecture treating data as a product', 'Mesh networking', 'Data visualization'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['Building platforms', 'Creating internal developer platforms to improve productivity', 'Hardware engineering', 'Social media platforms'],
      correctIndex: 1,
