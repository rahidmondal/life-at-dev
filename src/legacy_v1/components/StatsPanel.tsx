...
export function StatsPanel({ mode = 'desktop' }: StatsPanelProps) {
  const { state } = useGame();
  const { stats } = state;
  ...
  return (
    <div className="flex h-full flex-col gap-4 overflow-y-auto rounded-xl border border-emerald-500/20 bg-gray-900/50 p-4 backdrop-blur-md lg:gap-5 lg:p-5">
      {/* Avatar & Job Card */}
      ...
      {/* Next Unlock */}
      <div className="mt-auto space-y-2 rounded-xl border border-purple-500/20 bg-purple-950/20 p-3">
