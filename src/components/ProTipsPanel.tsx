...
export function ProTipsPanel() {
  return (
    <div className="flex h-full flex-col gap-6 overflow-y-auto border-l border-gray-800 bg-black p-6">
      {/* Header */}
      <div className="flex items-center gap-2">
        <span className="text-xl">💡</span>
        <h3 className="font-mono text-sm font-bold text-emerald-400">PROTIPS</h3>
      </div>

      {/* Tips */}
      <div className="space-y-4">
        <div className="space-y-2 border-l-2 border-cyan-500 bg-cyan-950/20 p-3">
        ...
        <div className="space-y-2 border-l-2 border-red-500 bg-red-950/20 p-3">
          <p className="font-mono text-xs font-bold text-red-400">😰 Stress kills</p>
          <p className="font-mono text-xs text-gray-400">If stress hits 100, you burn out. Game over.</p>
        </div>

        <div className="space-y-2 border-l-2 border-emerald-500 bg-emerald-950/20 p-3">
          <p className="font-mono text-xs font-bold text-emerald-400">💻 Skill unlocks better jobs</p>
          <p className="font-mono text-xs text-gray-400">LeetCode grind is real.</p>
        </div>

        <div className="space-y-2 border-l-2 border-yellow-500 bg-yellow-950/20 p-3">
          <p className="font-mono text-xs font-bold text-yellow-400">⭐ Reputation opens doors</p>
          <p className="font-mono text-xs text-gray-400">Network and build in public.</p>
        </div>

        <div className="space-y-2 border-l-2 border-green-500 bg-green-950/20 p-3">
          <p className="font-mono text-xs font-bold text-green-400">💰 Money grows with promotions</p>
          <p className="font-mono text-xs text-gray-400">Chase that TC!</p>
        </div>
      </div>
      ...
      <div className="space-y-4 border-t border-gray-800 pt-4">
        ...
        <div className="space-y-2">
          <div className="rounded bg-green-950/30 p-2">
            ...
            <p className="font-mono text-xs text-gray-400">Free rent + tuition for 4 years. Best for learning.</p>
          </div>

          <div className="rounded bg-yellow-950/30 p-2">
            <p className="font-mono text-xs font-bold text-yellow-400">Medium: Self-Taught</p>
            <p className="font-mono text-xs text-gray-400">Flexible but grindy. No degree debt.</p>
          </div>
      ...
      <div className="space-y-4 border-t border-gray-800 pt-4">
        ...
        <div className="space-y-2">
          ...
          <div className="rounded bg-red-950/30 p-2">
            ...
            <p className="font-mono text-xs text-gray-400">Stress hits 100</p>
          </div>

          <div className="rounded bg-gray-900 p-2">
            <p className="font-mono text-xs font-bold text-gray-400">Bankruptcy</p>
            <p className="font-mono text-xs text-gray-400">Money drops below $0</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4 border-t border-gray-800 pt-4">
        ...
        <div className="space-y-2">
          ...
          <p className="mt-3 font-mono text-xs italic text-gray-600">
